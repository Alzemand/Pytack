...
"""
Scrypt'Tor - Slow POST Denial Of Service Testing Tool
Version 1.0 Beta
...
def usage():
    print "./scrypttorddos.py -t <target> [-r <threads> -p <port> -T -h]"
    ...
    print "Eg. ./scrypttorddos.py -t IPALVO -r 256\n"
...
if __name__ == "__main__":
    print "\n/*"
    print " *"+term.RED + " Scrypt's Tor "+term.NORMAL
    print " * Slow POST DoS Testing Tool"
    print " * Version .0 Beta"
    print " */\n"
